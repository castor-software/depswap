...
public class JSONObject extends JSON implements Map<String, Object>, Cloneable, Serializable, InvocationHandler {
    ...
    public JSONObject(Map<String, Object> map){
        ...
        for(String key: map.keySet()) {
            try {
                json.YASJF4J_put(key, map.get(key));
            } catch (JException e) {
                e.printStackTrace();
            }
        }
    ...
    public boolean containsKey(Object key) {
        ...
        return result;*/
        boolean result = json.YASJF4J_getKeys().contains(key);
        if (!result) {
            if (key instanceof Number
                    || key instanceof Character
                    || key instanceof Boolean
                ...
                result = json.YASJF4J_getKeys().contains(key.toString());
            }
        }
        return result;
    }
    ...
    public boolean containsValue(Object value) {
        ...
        for(String k: json.YASJF4J_getKeys()) {
            try {
                if(json.YASJF4J_get(k).equals(value)) {
                    return true;
                }
            } catch (JException e) {
                e.printStackTrace();
    ...
    public JSONObject getJSONObject(String key) {
        ...
        */
        ...
        return new JSONObject((JSONObject) toJSON(value));
