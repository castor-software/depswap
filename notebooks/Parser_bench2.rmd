...
p1 <- dataset %>% filter(Category == "correct") %>% 
  filter(Parser %in% c("yasjf4j-fastjson","yasjf4j-gson","yasjf4j-json","yasjf4j-json-simple","yasjf4j-jackson")) %>%
...
a <- avg_distance(da, c("yasjf4j-fastjson","yasjf4j-gson","yasjf4j-json","yasjf4j-json-simple","yasjf4j-jackson"))
a

da <- d2 %>% filter(Category == "errored") %>% 
  filter(Parser %in% c("yasjf4j-fastjson","yasjf4j-gson","yasjf4j-json","yasjf4j-json-simple","yasjf4j-jackson")) %>%
  select(Parser,File,Result) %>% spread(Parser, Result)
b <- avg_distance(da, c("yasjf4j-fastjson","yasjf4j-gson","yasjf4j-json","yasjf4j-json-simple","yasjf4j-jackson"))
b

mparsers <- c("yasjf4j-fastjson","yasjf4j-gson","yasjf4j-json","yasjf4j-json-simple","yasjf4j-jackson")
...
c_jackson <- isOk %>% filter(`yasjf4j-jackson` == TRUE)

ven_in <- list(c_fastjson$File, c_gson$File, c_json$File, c_json_simple$File, c_jackson$File)
snames = c("yasjf4j-fastjson","yasjf4j-gson","yasjf4j-json","yasjf4j-json-simple","yasjf4j-jackson")
...
snames = c("yasjf4j-fastjson","yasjf4j-gson","yasjf4j-json","yasjf4j-json-simple","yasjf4j-jackson","yasjf4j-cookjson","yasjf4j-json-io")#,"yasjf4j-jsonp")
